...
stats <- data.table::fread(
  "/mnt/isilon/u01_project/large-scale/liuc9/raw/GSE226602/final/GSM7080044/cell.variant_stats.tsv.gz"
)
all_variants <- readxl::read_excel(
  "/home/liuc9/github/scMOCHA-data/data/GSE226602/final/GSM7080044/cell_variant_annotation.xlsx"
)
