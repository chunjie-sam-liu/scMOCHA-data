...
fn_plot_mtdna_circos <- function(
  ...
  d = 1,
  e = 16569,
  f = import("/home/liuc9/github/scMOCHA-data/config/mtdna_genes_dloop.qs"),
  g = import(
    "/home/liuc9/github/scMOCHA-data/config/chrM.phastCons100way.wigFix.qs"
  ),
  h = import("/home/liuc9/github/scMOCHA-data/analysis/zzz/db/gnomad.qs"),
  i = import(
  ...
  for (o in seq_len(nrow(n))) {
    ...
    draw.sector(
      ...
      rou2 = 0.09,
      clock.wise = TRUE,
      col = prismatic::clr_alpha(n$COLOR[o], alpha = 0.3),
      border = NA
    )
  }
  circos.genomicTrack(
