...
export(
  admeta_sc5p_variant_type_af_ttest,
  file = file.path(outdir, "admeta_sc5p_variant_type_af_ttest_fisher.qs"),
  format = "qs"
)
admeta_sc5p_variant_type_af_ttest <- import(file.path(
  outdir,
  "admeta_sc5p_variant_type_af_ttest_fisher.qs"
))
...
ggsave(
  filename = file.path(outdir, "ad-variant_pointplot-ttest-all-fisher.pdf"),
...
ggsave(
  filename = file.path(outdir, "ad-variant_boxplot-fisher.pdf"),
