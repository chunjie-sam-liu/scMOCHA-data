...
heteroplasmic |>
  ...
  dplyr::arrange(-n) -> heteroplasmic_disease
...
{
  pdf(
    file = "/home/liuc9/github/scMOCHA-data/analysis/zzz/plot-heteroplasmic/heatmap_cluster_af.homo+hetero-fisher.pdf",
    width = 22,
    height = 9
  )
